...
epsilon('C','1') = 0;	epsilon('C','2') = 0;	epsilon('C','3') = 0;	epsilon('C','4') = 0;	epsilon('C','5') = 0;	epsilon('C','6') = 0;	epsilon('C','7') = 0;	epsilon('C','8') = 0;	epsilon('C','9') = 0;	epsilon('C','10') = 0;
epsilon('D','1') = 0;	epsilon('D','2') = 0;	epsilon('D','3') = 0;	epsilon('D','4') = 0;	epsilon('D','5') = 0;	epsilon('D','6') = 0;	epsilon('D','7') = 0;	epsilon('D','8') = 0;	epsilon('D','9') = 0;	epsilon('D','10') = 0;
...
SOLVE SPLogit MAXIMIZING PROFIT1 USING MINLP;